...
//non-standard status codes goes here

//NOT OK
statusCodes[exports.MISSING_FIELDS = 1000] = "Missing Mandatory Field(s)";
statusCodes[exports.ERROR_DB = 1001] = "DB Error!";
statusCodes[exports.ROUTE_NOT_FOUND = 1002] = "API Endpoint not found!";

//OK
statusCodes[exports.OK_ADD_GROUP = 2000] = "Group added!";
statusCodes[exports.OK_ADD_MEMBER = 2001] = "Group Member added!";
statusCodes[exports.OK_DELETE_GROUP = 2002] = "Group Deleted!";
statusCodes[exports.OK_UPDATE_ORDER = 2003] = "Order Updated!";
